...
The separate Agent protocol is currently v2.14. It carries Spec source grounding,
diagnostic finalization checkpoints, and locator recovery exhaustion reasons;
